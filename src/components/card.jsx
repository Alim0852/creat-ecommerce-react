...
const Cards = () => {
  ...
  return (
    <>
    <Box sx={{ display: "flex", justifyContent: "center", width: "100%" }}><img style={{width: "100%"}} src={Image} alt="watches" /></Box>
      ...
      >
        {data &&
          data.map((item) => (
            ...
            >
              <CardMedia
               component="watches.jpg" // Use this to set the media component as an image
                sx={{
                  height: 220,
                  width: 220,
                  obejectFit: "contain",
                }}
                image={item.images && item.images[0] ? item.images[0] : "assets/watchesjpg"} 
              />
              ...
              <CardActions sx={{ justifyContent: "" }}>
                <Button  onClick={() => handleCardClick(item.id)} size="small" variant="contained" className="custom-navbar" >
                  Learn More
                </Button>
              </CardActions>
            </Card>
